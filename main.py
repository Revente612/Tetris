...
async def vape(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    new_juice = max(0, player['vape_juice'] - 1)  # было -5
    new_battery = max(0, player['vape_battery'] - 2)  # было -10
    new_health = max(0, player['health'] - health_decrease)
    new_happiness = min(100, player['happiness'] + 25)
...
async def nurik_vape_shop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("💨 Xros 3 Mini (4500 руб.)", callback_data="buy_xros_3")],
    ...
    await query.edit_message_text(
        "🛒 Магазин NurikVape - Премиум товары\n\n"
        "💨 Вейпы:\n"
        "• Xros 3 Mini - 4500 руб.\n"
        ...
        "⚠️ Внимание! Снюс 1000 мг может разъесть губу и отправить в больницу!",
